...
const SAMPLE_PRODUCTS: Product[] = [
  {
    id: '1009-black',
    title: '1009 HEAVYWEIGHT T-SHIRT BUY 3 - SAVE 10%',
  ...
  {
    id: '1008-white',
    title: '1008 MIDWEIGHT T-SHIRT BUY 3 - SAVE 10%',
  ...
  return (
    <main className="max-w-6xl mx-auto py-12 px-4">
      <header className="mb-6">
        <h2 className="text-lg font-medium tracking-wide text-gray-700">BESTSELLERS</h2>
      </header>
          ...
          <article key={p.id} className="group">
            ...
            <div className="mt-3">
              ...
              <div className="mt-1 flex items-center justify-between text-sm text-gray-600">
                <span>{p.price}</span>
                {p.badge && <span className="text-xs text-indigo-600 font-medium">{p.badge}</span>}
              </div>
            </div>
          </article>
        ))}
