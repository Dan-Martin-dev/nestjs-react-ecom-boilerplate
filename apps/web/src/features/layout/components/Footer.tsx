      ...
      <footer className="bg_varels_pink  text-black">
        <div className="bg_varels_pink container mx-auto px-6 py-5 md:py-12">
          ...
          <div className="bg_varels_pink mt-5 grid grid-cols-1 gap-3 md:gap-6 md:grid-cols-3 lg:grid-cols-5">
            ...
            <div>
              <h4 className="font-teko text-sm md:text-base lg:text-3xl font-normal uppercase mb-3">
                Social media
              </h4>
              <div className="flex items-center gap-3 mb-4">
                ...
                <a
                  href="#"
                  aria-label="Facebook"
                  className="text-white/90 hover:text-white transform hover:scale-105"
                >
                  <svg
                    width="20"
                    height="20"
              ...
              <ul className="flex flex-wrap gap-2">
                {popularSearches.map((p) => (
                  <li key={p} className="w-1/2">
                    <Link to="#" className="text-sm underline opacity-90">
                      {p}
                    </Link>
                  </li>
                ))}
