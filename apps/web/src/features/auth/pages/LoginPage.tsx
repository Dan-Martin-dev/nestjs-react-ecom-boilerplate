...
const LoginPage: React.FC = () => {
  ...
  {/* Back button moved below the bottom auth link (see wrapper near the end of the file) */}
      ...
      <h1 className="text-2xl font-monos font-semibold text-gray-900 mb-4 text-center md:text-left uppercase">Sign in</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <label className="block">
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border-gray-300 px-3 py-2 font-monos text-sm text-gray-800 normal-case-input mixed-case"
        ...
        <div className="flex items-center">
          <Switch
            ...
            label={<span className="font-monos text-sm text-gray-700 uppercase">Remember me</span>}
            color="dark"
            size="sm"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          <button
            type="submit"
            className="inline-flex items-center justify-center rounded bg-black text-white px-4 py-2 disabled:opacity-60 font-monos font-medium"
            disabled={isLocked || isSubmitting}
          >
            {isSubmitting ? (
              <>
          ...
          <Link to="/password-reset" className="text-sm font-monos text-gray-600 uppercase">
            Forgot password?
          </Link>
        </div>
        </fieldset>
    ...
    <div className="mt-6 grid grid-cols-3 gap-3">
      ...
      <div className="mt-6 text-sm font-monos text-gray-700 relative">
        <div className="flex items-center justify-between">
          ...
          <Link to="/auth/register" className="text-blue-600 font-monos font-medium underline mr-6 uppercase">
            Create one
          </Link>
        </div>
